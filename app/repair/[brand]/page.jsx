...
export default async function BrandRepairPage({ params }) {
  ...
  // Pre-fill model selection link helper
      ...
      >
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center lg:text-left">
          ...
          <p className="text-sm lg:text-base text-[var(--color-content-text-secondary)] leading-relaxed mb-10 max-w-[620px]">
            Professional, OEM-grade repair solutions for all {brandName} smartphones, tablets, and laptops. Swapping screens, restoring batteries, and fixing motherboards with dedicated factory calibration.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <RepairLandingClient brandObj={parsedBrandObj} step="select-model" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 lg:px-16 bg-[#0b0c15] border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--color-accent)] block mb-2">SERVICE PRICING INDEX</span>
            <h2 className="text-3xl font-black uppercase tracking-wider mb-4">{brandName} Repair Matrix</h2>
          ...
          <div className="bg-[#121323] border border-white/5 rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="divide-y divide-white/5">
              {[
                { name: 'Screen Replacement', pro: '₹1,999', premium: '₹3,499' },
                { name: 'Battery Swap', pro: '₹999', premium: '₹1,799' },
                { name: 'Charging Port Fix', pro: '₹899', premium: '₹1,399' },
                { name: 'Back Glass Restoration', pro: '₹1,199', premium: '₹1,999' },
                { name: 'Camera Module Repair', pro: '₹1,499', premium: '₹2,699' },
                { name: 'Speaker / Audio Repair', pro: '₹799', premium: '₹1,199' }
              ].map((row, idx) => (
      ...
      <section className="py-20 px-6 lg:px-16 bg-[#111222]">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          <div className="bg-[#0b0c16] border border-white/5 p-8 rounded-3xl">
            ...
            <h3 className="font-extrabold uppercase text-xs tracking-wider mb-2">Same Day Priority</h3>
            <p className="text-xs text-[var(--color-content-text-secondary)] leading-relaxed">
              We diagnose and repair your {brandName} device on-site, completing most diagnostic operations in 45-60 minutes.
            </p>
          </div>

          <div className="bg-[#0b0c16] border border-white/5 p-8 rounded-3xl">
            <ShieldCheck className="text-[var(--color-accent)] w-10 h-10 mb-6 mx-auto md:mx-0" />
            <h3 className="font-extrabold uppercase text-xs tracking-wider mb-2">90-Day Coverage</h3>
            <p className="text-xs text-[var(--color-content-text-secondary)] leading-relaxed">
              Peace of mind is standard. Every single part replacement comes loaded with a 90-day coverage warrantying spontaneous issues.
            </p>
          </div>

          <div className="bg-[#0b0c16] border border-white/5 p-8 rounded-3xl">
            <Star className="text-[var(--color-accent)] w-10 h-10 mb-6 mx-auto md:mx-0" />
            <h3 className="font-extrabold uppercase text-xs tracking-wider mb-2">Certified Specialists</h3>
            <p className="text-xs text-[var(--color-content-text-secondary)] leading-relaxed">
              Our workshop features highly trained hardware engineers using clean room tools and calibrated diagnostic micro-soldering.
            </p>
          </div>
        </div>
      </section>
