  ...
  return (
    <div className='schedule-page-shell'>
      ...
      <div className='home-mobile lg:hidden min-h-[100svh] relative overflow-hidden bg-[#222222]'>
        {/* Content */}
        <div className='relative z-10 pt-[72px] pb-[100px] bg-[#0A0A0A] min-h-[100svh] mt-[-20px]'>
          ...
          {/* Date Selection */}
          <div className='mb-8'>
            <h3 className='px-5 text-sm font-bold text-[#E0E0E0] mb-3'>
              Select Date
            </h3>
            <div className='flex overflow-x-auto gap-3 px-5 p-2 -m-2 pb-2 scrollbar-hide'>
              {availableDates.map((d, idx) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`text-[11px] font-bold ${isSelected ? 'text-[#888]' : 'text-[#666]'}`}
                    >
                      {dayLabel}
                    </span>
                    <span
                      className={`text-2xl font-black mt-0.5 mb-0.5 ${isSelected ? 'text-white' : 'text-[#E0E0E0]'}`}
                    >
                      {dateLabel}
                    </span>
                    <span
          ...
          <div className='mb-8 px-5'>
            ...
            <div className='grid grid-cols-2 gap-3'>
              {isLoading ? (
                <div className='col-span-2 text-center text-sm text-[#666] py-4'>
                  Loading slots...
                </div>
              ) : timeSlots.length > 0 ? (
                timeSlots.map((t, idx) => {
        ...
        <div className='max-w-6xl mx-auto p-10 flex gap-12'>
          <div className='flex-1'>
            ...
            <div className='flex items-center justify-between mb-6'>
              ...
              <span className='text-sm font-bold text-white underline decoration-2 underline-offset-4'>
            ...
            <div className='flex gap-4 mb-12 overflow-x-auto p-2 -m-2'>
              {availableDates.map((d, idx) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`text-[13px] font-bold uppercase ${isSelected ? 'text-[#888]' : 'text-[#666]'}`}
                    >
                      {dayLabel}
                    </span>
                    <span
                      className={`text-3xl font-black mt-1 ${isSelected ? 'text-white' : 'text-[#E0E0E0]'}`}
                    >
                      {dateLabel}
                    </span>
                  </button>
          ...
          <div className='w-[400px]'>
            <div className='bg-[#0A0A0A] rounded-[24px] p-6 h-full border border-[#222]'>
              <h3 className='text-xs font-black text-[#888] uppercase tracking-wider mb-4'>
                SERVICE CENTER
              </h3>
