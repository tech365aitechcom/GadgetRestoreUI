...
export default function SplashOrLandingPage() {
  ...
  const handleBookNowCTA = (customBrand = null) => {
    ...
    if (customBrand) {
      const appleBrand = { _id: "65f8c8577adcd9e5c544d673", name: "Apple", logo: "/images/apple-logo.png" };
      localStorage.setItem('gr_booking_state', JSON.stringify({
        brand: appleBrand,
    ...
    <div className="min-h-screen bg-white text-zinc-900 font-sans flex flex-col selection:bg-[var(--color-accent)] selection:text-white overflow-x-hidden">
      ...
      <div className="hidden md:flex bg-[#FAF9FF] border-b border-zinc-100 py-4 px-6 lg:px-20 justify-between items-center gap-4 text-xs">
        ...
        <div className="flex items-center gap-8 text-zinc-500">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-extrabold text-zinc-800 text-[11px] tracking-wider">Opening Time</div>
              <div className="text-[11px] font-medium">Allday 9.00 - 18.00</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-extrabold text-zinc-800 text-[11px] tracking-wider">Email Us</div>
              <a href="mailto:info@techfixpro.com" className="text-[11px] font-medium hover:text-[var(--color-accent)] transition-colors">info@techfixpro.com</a>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-extrabold text-zinc-800 text-[11px] tracking-wider">Call Us Now</div>
              <a href="tel:+2512353256" className="text-[11px] font-black text-[var(--color-accent)] tracking-wide hover:underline">+251-235-3256</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <nav className="bg-white border-b border-zinc-100 py-4 px-6 lg:px-20 sticky top-0 z-50 backdrop-blur-md bg-opacity-95 flex justify-between items-center shadow-sm">
        ...
        <div className="hidden lg:flex items-center gap-8 font-black text-xs tracking-widest text-zinc-500">
          <a href="#hero" className="text-zinc-900 border-b-2 border-[var(--color-accent)] pb-1 hover:text-zinc-900 transition-colors cursor-pointer">Home</a>
          <a href="#expertise" className="hover:text-zinc-900 transition-colors cursor-pointer">Services</a>
          <a href="#why-choose-us" className="hover:text-zinc-900 transition-colors cursor-pointer">About</a>
          <a href="#faq" className="hover:text-zinc-900 transition-colors cursor-pointer">FAQs</a>
          <a href="#contact" className="hover:text-zinc-900 transition-colors cursor-pointer">Contact</a>
        </div>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-x-0 top-[73px] z-50 bg-white/98 backdrop-blur-md flex flex-col justify-between px-6 py-10 border-t border-zinc-100 shadow-2xl h-[calc(100vh-73px)]">
          <div className="flex flex-col gap-6 font-black text-sm tracking-widest text-zinc-500">
            <a href="#hero" onClick={() => setMobileMenuOpen(false)} className="hover:text-zinc-900 py-3 border-b border-zinc-100/50 cursor-pointer">Home</a>
            <a href="#services" onClick={() => setMobileMenuOpen(false)} className="hover:text-zinc-900 py-3 border-b border-zinc-100/50 cursor-pointer">Services</a>
            <a href="#why-choose-us" onClick={() => setMobileMenuOpen(false)} className="hover:text-zinc-900 py-3 border-b border-zinc-100/50 cursor-pointer">About</a>
            <a href="#faq" onClick={() => setMobileMenuOpen(false)} className="hover:text-zinc-900 py-3 border-b border-zinc-100/50 cursor-pointer">FAQs</a>
            <a href="#contact" onClick={() => setMobileMenuOpen(false)} className="hover:text-zinc-900 py-3 border-b border-zinc-100/50 cursor-pointer">Contact</a>
          </div>

          <div className="flex flex-col gap-6">
            <button
              onClick={() => { setMobileMenuOpen(false); handleBookNowCTA(); }}
            ...
            <div className="flex items-center gap-4 bg-[#FAF9FF] p-4 rounded-2xl border border-zinc-100">
              ...
              <div>
                <div className="font-extrabold text-zinc-800 text-[10px] tracking-wider uppercase">Call Us Now</div>
                <a href="tel:+2512353256" className="text-xs font-black text-[var(--color-accent)] tracking-wide hover:underline">+251-235-3256</a>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ────────────────────────────────────────────────────────────────────────
          ...
          ──────────────────────────────────────────────────────────────────────── */}
      <section id="hero" className="relative min-h-[90vh] flex items-center px-6 lg:px-20 py-24 overflow-hidden bg-cover bg-center"
        style={{
          backgroundImage: "linear-gradient(rgba(11, 12, 22, 0.02), rgba(11, 12, 22, 0.02)), url('/images/landing-banner.png')"
        }}
      >
        <div className="max-w-[750px] relative z-10 text-white">
          ...
          <p className="text-sm lg:text-base text-zinc-300 leading-relaxed mb-10 max-w-[620px]">
            Mobile, Laptop, Computer & Electronics Repair. We bring your essential devices back to life with surgical precision and certified expertise.
          </p>
      ...
      <section id="expertise" className="py-24 px-6 lg:px-20 bg-white relative">
        <div className="text-center max-w-[600px] mx-auto mb-16">
          <h2 className="text-3xl font-black tracking-wider text-zinc-900 mb-4">Our Expertise</h2>
          <div className="w-16 h-1 bg-[var(--color-accent)] mx-auto rounded-full"></div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {[
            { title: 'Phone Repair', desc: 'Expert screen and battery services for all major smartphone models.', icon: <Smartphone size={22} /> },
            { title: 'Desktop Repair', desc: 'Custom builds, hardware upgrades, and performance troubleshooting.', icon: <Monitor size={22} /> },
            { title: 'Tablet Repair', desc: 'Professional iPad and Android tablet repairs including screen swaps.', icon: <Tablet size={22} /> },
            { title: 'Console Repair', desc: 'Fixes for PlayStation, Xbox, and Nintendo Switch systems.', icon: <Gamepad size={22} /> },
            { title: 'Phone Accessory', desc: 'Custom cases, chargers, and audio gear for your mobile lifestyle.', icon: <Headphones size={22} /> },
            { title: 'Laptop Repair', desc: 'MacBook and PC laptop hardware maintenance and software fixes.', icon: <Laptop size={22} /> }
          ].map((item, index) => (
            <div key={index}
              onClick={() => handleBookNowCTA(item.title === 'Phone Repair' ? 'Apple' : null)}
            ...
            >
              ...
              <h3 className="text-md font-extrabold tracking-wide text-zinc-900 mb-3">{item.title}</h3>
      ...
      {/* ────────────────────────────────────────────────────────────────────────
          ...
          ──────────────────────────────────────────────────────────────────────── */}
      <section id="services" className="py-24 px-6 lg:px-20 relative border-t border-zinc-100 bg-cover bg-center"
        style={{
          backgroundImage: "linear-gradient(rgba(255, 255, 255, 0.45), rgba(255, 255, 255, 0.45)), url('/images/landing-banner.png')"
        }}
      >
        <div className="text-center max-w-[600px] mx-auto mb-16">
          <h2 className="text-3xl font-black tracking-wider text-zinc-900 mb-2">Our Services</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {[
            ...
            <div key={index}
              onClick={() => handleBookNowCTA(item.title.includes('Phone') ? 'Apple' : null)}
            ...
            >
              ...
              <div className="p-4 flex flex-col justify-center flex-1">
                <div>
                  <h3 className="font-extrabold tracking-wider text-center text-sm text-zinc-900 mb-3 group-hover:text-[var(--color-accent)] transition-colors">{item.title}</h3>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 relative pr-4 pb-4">
            <div className="relative overflow-hidden rounded-[32px] border border-zinc-100 shadow-xl shadow-zinc-100">
              ...
              <div className="absolute bottom-0 right-6 bg-black text-white px-6 py-5 rounded-2xl shadow-2xl flex flex-col justify-center min-w-[160px]">
                <span className="text-3xl font-black tracking-tight leading-none text-white">15+</span>
                <span className="text-[9px] uppercase font-black text-zinc-400 mt-1 tracking-wider leading-tight">Years of Experience</span>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-sm text-zinc-500 leading-relaxed mb-8">
              At TechFix Pro, we understand how vital your devices are to your daily life and business. Our team of certified specialists brings a combined 15 years of technical expertise to every diagnostic and repair.
            </p>

            <div className="flex flex-col gap-6">
              {[
                { text: 'Certified Technicians with specialized training.', icon: <ShieldCheck size={20} className="text-zinc-950 shrink-0" /> },
                { text: 'Fast Service with many same-day repair options.', icon: <Clock size={20} className="text-zinc-950 shrink-0" /> },
                { text: 'Affordable Pricing with no hidden diagnostics fees.', icon: <Award size={20} className="text-zinc-950 shrink-0" /> }
              ].map((bullet, idx) => (
                <div key={idx} className="flex items-center gap-4">
                  <div className="mt-0.5 text-zinc-950">
                    {bullet.icon}
                  </div>
                  <span className="text-xs font-black text-zinc-800 leading-tight">{bullet.text}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-24 px-6 lg:px-20 bg-[#FAF9FF] border-t border-zinc-100">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
          {[
            { title: 'Same Day Repair', desc: 'Most repairs completed within hours of drop-off.', icon: <Clock size={22} /> },
            { title: '90-Day Warranty', desc: 'Peace of mind with our extensive parts and labor warranty.', icon: <Award size={22} /> },
            { title: 'Expert Team', desc: 'Certified professionals for every electronic niche.', icon: <Users size={22} /> },
            { title: 'Data Privacy', desc: 'Strict protocols to keep your personal data secure.', icon: <ShieldCheck size={22} /> }
          ].map((item, idx) => (
            <div key={idx} className="bg-white border border-zinc-100 p-8 rounded-[24px] flex flex-col items-center text-center shadow-sm hover:shadow-md transition-all duration-300 group min-h-[260px] justify-center">
              ...
              <h4 className="text-sm font-black text-zinc-900 mb-3">{item.title}</h4>
              <p className="text-xs text-zinc-500 leading-relaxed max-w-[220px]">{item.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* ────────────────────────────────────────────────────────────────────────
          ...
          ──────────────────────────────────────────────────────────────────────── */}
      <section id="why-choose-us" className="pt-12 px-6 lg:px-20 bg-white relative overflow-hidden">
        <div className="text-center max-w-[600px] mx-auto mb-10">
          <h2 className="text-3xl font-black tracking-wider text-zinc-900 mb-2">Why Choose Us?</h2>
          <div className="flex justify-center items-center gap-2 mb-4">
            <span className="w-8 h-[1px] bg-zinc-300"></span>
            <Wrench size={14} className="text-zinc-400" />
            <span className="w-8 h-[1px] bg-zinc-300"></span>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full lg:w-1/3 flex flex-col gap-12 lg:text-right">
            <div>
              ...
              <h3 className="text-md font-extrabold tracking-wider text-zinc-900 mb-3">Low Cost</h3>
              <p className="text-xs text-zinc-500 leading-relaxed">
                Competitive pricing on all repairs and parts without compromising on quality standards.
              </p>
            </div>
            ...
            <div>
              ...
              <h3 className="text-md font-extrabold tracking-wider text-zinc-900 mb-3">Best Materials</h3>
              <p className="text-xs text-zinc-500 leading-relaxed">
                We use only high-grade OEM or premium aftermarket components for every single device repair.
              </p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/3 flex flex-col gap-12">
            <div>
              ...
              <h3 className="text-md font-extrabold tracking-wider text-zinc-900 mb-3">Best Professionals</h3>
              <p className="text-xs text-zinc-500 leading-relaxed">
                Our technicians undergo rigorous training and certification to handle the most complex hardware issues.
              </p>
            </div>
            ...
            <div>
              ...
              <h3 className="text-md font-extrabold tracking-wider text-zinc-900 mb-3">Low Cost</h3>
              <p className="text-xs text-zinc-500 leading-relaxed">
                Transparent diagnostic fees and upfront quotes so you always know exactly what you are paying for.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="pt-23 md:pt-6 pb-24 px-6 lg:px-20 bg-white">
        <div className="text-center mx-auto mb-20">
          <h2 className="text-3xl font-black text-zinc-900 mb-2">How It Works</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative">
          ...
          {[
            { icon: <Calendar size={22} className="text-zinc-900" />, title: 'Book Service', desc: 'Schedule online or drop by our store for an instant intake.' },
            { icon: <Search size={22} className="text-zinc-900" />, title: 'Diagnose', desc: 'We perform a deep technical audit and provide a clear quote.' },
            { icon: <Wrench size={22} className="text-zinc-900" />, title: 'Repair', desc: 'Our experts fix the issue using high-quality components.' },
            { icon: <Package size={22} className="text-zinc-900" />, title: 'Deliver', desc: 'Quality check completed and your device is ready for pickup.' }
          ].map((item, idx) => (
            <div key={idx} className="flex flex-col items-center text-center relative z-10">
              ...
              <h3 className="font-extrabold text-sm text-zinc-900 mt-6 mb-2">{item.title}</h3>
      ...
      {/* ────────────────────────────────────────────────────────────────────────
          ...
          ──────────────────────────────────────────────────────────────────────── */}
      <section id="contact" className="grid grid-cols-1 lg:grid-cols-2 bg-[#05060f] overflow-hidden border-t border-zinc-900">
        ...
        <div className="py-24 px-8 lg:px-24 bg-[#07080e] flex flex-col justify-center text-white relative">
          <div className="max-w-[480px]">
            <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-zinc-400 block mb-2">WANT TO</span>
      ...
      >
        ...
        <div className="w-full mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-16 relative z-10">
          {[
            { step: '1', icon: <Monitor size={22} className="text-white" />, title: 'Damage Device' },
            { step: '2', icon: <Send size={22} className="text-white" />, title: 'Send it to Us' },
            { step: '3', icon: <Settings size={22} className="text-white" />, title: 'Repair Device' },
            { step: '4', icon: <RotateCcw size={22} className="text-white" />, title: 'Quick Return' }
          ].map((item, idx) => (
            <div key={idx} className="flex flex-col items-center text-center group">
              ...
              <h3 className="font-extrabold text-sm text-white tracking-wide mt-2">{item.title}</h3>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="bg-[#FAF9FF] border border-zinc-100 rounded-[32px] p-8 lg:p-10 shadow-sm relative overflow-hidden">
              <div className="flex items-center gap-4 mb-6">
                ...
                />
                <div>
                  <h4 className="font-extrabold tracking-wide text-zinc-900 text-xs">Julia Robertson</h4>
                  <p className="text-[10px] text-zinc-400 font-bold tracking-wider mt-0.5">Happy Clients</p>
                </div>
              </div>
              <p className="text-xs text-zinc-600 italic leading-relaxed mb-6">
                "The level of professionalism and technical skill at TechFix Pro is unmatched. They fixed my iPad screen in under two hours, and it looks brand new. I highly recommend them to anyone looking for quality repairs."
              </p>
          ...
          <div id="faq" className="w-full lg:w-1/2">
            ...
            <div className="flex flex-col gap-4">
              {[
                { q: 'How long does a typical repair take?', a: 'Most repairs, like screen or battery replacements, are completed within 1 to 2 hours. More complex issues involving motherboard repair or data recovery may take 24–48 hours depending on the damage.' },
                { q: 'Do you provide a warranty?', a: 'Yes, every repair is covered under our structural 90-day warranty, guarding against any defect in materials and craftsmanship.' },
                { q: 'Do I need an appointment?', a: 'No, you can simply drop by our workshop during business hours, but booking online guarantees priority check-in.' },
                { q: 'What devices do you repair?', a: 'We repair all models of smart phones, iPads/tablets, MacBooks/PCs, gaming consoles, and various phone accessories.' }
              ].map((faq, idx) => {
                const isOpen = activeFaq === idx;
                return (
                  <div key={idx} className="bg-white border border-zinc-100 rounded-2xl overflow-hidden transition-all duration-300">
                    <button
                    ...
                    >
                      <span>{faq.q}</span>
                      <ChevronDown size={14} className={`text-zinc-500 transform transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`} />
                    </button>
                    {isOpen && (
      ...
      <section className="py-24 px-6 lg:px-20 bg-[#FAF9FF] border-t border-zinc-100">
        <div className="mb-16">
          <h2 className="text-3xl font-black tracking-wider text-zinc-900 mb-2">Tech Tips & News</h2>
          <p className="text-xs text-zinc-400 font-bold tracking-wider">Insights from our repair lab to keep your tech healthy.</p>
        </div>
          ...
          {[
            ...
            <div key={idx} className="bg-white rounded-xl overflow-hidden border border-zinc-100 flex flex-col justify-between hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-extrabold text-sm tracking-wide text-zinc-900 mb-3 leading-snug group-hover:text-[var(--color-accent)] transition-colors">{post.title}</h3>
                  <p className="text-xs text-zinc-500 leading-relaxed mb-6">{post.desc}</p>
                </div>
                <a
                  onClick={() => handleBookNowCTA()}
      ...
      <section className="py-20 px-6 lg:px-20 bg-black text-center relative overflow-hidden border-t border-white/5">
        <div className="max-w-[800px] mx-auto relative z-10 text-white">
          <div className="text-[var(--color-accent)] text-6xl font-black mb-6 select-none">“</div>
          <p className="text-base lg:text-xl font-medium italic text-zinc-200 leading-relaxed mb-8">
            "TechFix Pro saved my business laptop after a coffee spill. They recovered all my sensitive data and had me back up and running within 24 hours. Professional, transparent, and absolutely worth every penny."
          </p>
          <div className="flex justify-center gap-1 mb-4 text-amber-400">
            {Array.from({ length: 5 }).map((_, i) => <Star key={i} size={14} fill="currentColor" />)}
          </div>
          <h4 className="font-extrabold tracking-widest text-xs text-white">Sarah Jenkins</h4>
          <span className="text-[10px] text-zinc-500 tracking-wider block mt-1">Managing Director, Studio J</span>
        </div>
      </section>
      ...
      <footer className="bg-black border-t border-white/5 py-12 px-6 lg:px-20 text-center text-xs text-zinc-600 font-sans">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          />
          <p className="tracking-widest text-[9px] font-bold">© 2026 GADGET RESTORE INC. TECHNICAL PRECISION. ALL RIGHTS RESERVED.</p>
          <div className="flex gap-6 text-[10px] font-black tracking-widest text-zinc-500">
            <span className="hover:text-white transition-colors cursor-pointer" onClick={() => router.push('/privacy')}>Privacy</span>
            <span className="hover:text-white transition-colors cursor-pointer" onClick={() => router.push('/terms')}>Terms</span>
          </div>
        </div>
      </footer>
