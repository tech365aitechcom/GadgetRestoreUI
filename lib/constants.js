...
export const API_BASE_URL =
  process.env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:7007'

// App info
export const APP_NAME = 'Gadget Restore'
export const SUPPORT_WHATSAPP = 'https://wa.me/918800003785'
export const SUPPORT_PHONE = 'tel:+918800003785'
